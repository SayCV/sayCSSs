...
if [ "$script_build_sigar_for_android" ]; then
        return
fi

export script_build_sigar_for_android="build_sigar_for_android.sh"

# get dir of the script
build_sigar_for_android_script_relaytive_path=`dirname "$0"`
...
function main {
	...
	fnct_build_sigar_for_android || die
}
